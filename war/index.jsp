...
<div id="content"> 
    <div id="content-left" class="shadow rounded">
    	<div class="content-title" style="background-color: #0085B2;">Bestaande klant?<img src="images/arrow-tip.fw.png" /></div>
       	<div class="content-container" style="width: 210px;">
       		<% Object msgLog = request.getAttribute("msgLog"); if (msgLog != null) { out.println("<div">" + msgLog + "</div>"); } %>
        	<form method="post" action="">
                <input class="form_input" type="text" name="username" id="username" value="Gebruikersnaam..." onblur="onBlur(this)" onfocus="onFocus(this)" />
	...
	<div id="content-right" class="sha<% Object msgReg = request.getAttribute("msgReg"); if (msgReg != null) { out.println("<div">" + msgReg + "</div>"); } %>dow rounded">
        ...
        <div class="content-container" style="width: 440px;">
        	<% Object msgReg = request.getAttribute("msgReg"); if (msgReg != null) { out.println("<div">" + msgReg + "</div>"); } %>
        	<form method="post" action="">
                <div style="float: left; width: 210px;">   
                    <input class="form_input" type="text" name="realname" id="realname" value="Voor- en achternaam..." onblur="onBlur(this)" onfocus="onFocus(this)" />
