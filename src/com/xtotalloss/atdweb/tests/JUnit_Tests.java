...
public class JUnit_Tests {
	...
	public void testMonteurToevoegenGeenNaam() throws OngeldigeMonteurException {
		Monteur geenNaam = new Monteur("", "achternaam", "3500AA", "21", "Utrecht", "test@test.nl", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test(expected = OngeldigeMonteurException.class)
	public void testMonteurToevoegenGeenPostcode() throws OngeldigeMonteurException {
		Monteur geenPostcode = new Monteur("voornaam", "achternaam", "", "21", "Utrecht", "test@test.nl", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test (expected = OngeldigeMonteurException.class)
	public void testMonteurToevoegenOngeldigePostcode() throws OngeldigeMonteurException {
		Monteur ongeldigePostcode = new Monteur("voornaam", "achternaam", "AA2222AA", "21", "Utrecht", "test@test.nl", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test(expected = OngeldigeMonteurException.class)
	public void testMonteurToevoegenGeenHuisnr() throws OngeldigeMonteurException {
		Monteur geenMonteurToevoegenHuisnr = new Monteur("voornaam", "achternaam", "3500AA", "", "Utrecht", "test@test.nl", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test(expected = OngeldigeMonteurException.class)
	public void testMonteurToevoegenGeenEmail() throws OngeldigeMonteurException {
		Monteur geenMonteurToevoegenEmail = new Monteur("voornaam", "achternaam", "3500AA", "21", "Utrecht", "", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test(expected = OngeldigeMonteurException.class)
	...
	public void testMonteurToevoegenGeenCijfersBSN() throws OngeldigeMonteurException {
		Monteur geenMonteurToevoegenCijfersBSN = new Monteur("voornaam", "achternaam", "3500AA", "21", "Utrecht", "test@test.nl", "0305590320", "bsn nr", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test(expected = OngeldigeMonteurException.class)
	public void testMonteurToevoegenOngeldigTelnr() throws OngeldigeMonteurException {
		Monteur testMonteurToevoegenOngeldigTelnr = new Monteur("voornaam", "achternaam", "3500AA", "21", "Utrecht", "test@test.nl", "A030AABBCCDD", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	@Test
	public void testMonteurToevoegenGeenException() throws OngeldigeMonteurException {
		Monteur testMonteurToevoegenGeenException = new Monteur("voornaam", "achternaam", "3500AA", "21", "Utrecht", "test@test.nl", "0305590320", "34534534", "3253675", "Gebruiker", "wachtwoord");
	}
	
	// Parkeer Garage
	
	@Test(expected = OngeldigeParkeergarageException.class)
	public void testParkeerGarageOngeldigeParkeergarage() throws OngeldigeParkeergarageException {
		ParkeerGarage ongeldigeParkeergarage = new ParkeerGarage(-10);
	}
	
	@Test(expected = OngeldigeParkeergarageException.class)
	public void testParkeerGarageTweeReserveringen() throws OngeldigeParkeergarageException {
	...
	@Test(expected = OngeldigeParkeergarageException.class)
	public void testParkeerGarageGeenReserveerder() throws OngeldigeParkeergarageException {
		ParkeerReservering geenReserveerder = new ParkeerReservering(null);
	}

	@Test
	public void testParkeerGarageGeenException() throws OngeldigeParkeergarageException {
